...
@pytest.mark.parametrize("data_0,data_1,max_diff_length, min_length_for_fit,res",
                         [(b"Hi! Duck", b"Hi! Duck", None, None, []),
                          (b"Hi! lala Duck Gargamel", b"Hi! Duck", None, None, [b"-4|lala ", b"-8| Gargamel"]),
                          (b"Hi! Duck", b"Hi! lili Duck", None, None, [b"+4|lili "]),
                          (b"Hi! lala Duck", b"Hi! ronron Duck", None, None, [b"%4|lala$ronron"]),
                          (b"Hi! lala Duck Gargamel", b"Hi! Duck shish gon", None, None,
                          ...
                          (b"Hello! My name is John Cena. %, + and - are signs used for parsing the delta. "
                           ...
                           b"There's also $ and |. To mark usage of safe signs in the text, we use \\.", 50, 3,
                           [b"%19|ohn Cena. \\%, \\+ and \\- a$eff Bazos. The", b"+36|are ",
                            b"%72|. In addition, there's \\|$, such as \\+, \\%",
                            b"%91|\\$. \\\\ is$\\-. There's also \\$ and \\|. To mark", b"-126|ed to mark us",
                            b"+155|, we use \\\\"]
                           ,),
                          ],

                         )
def test_generate_delta(data_0: bytes, data_1: bytes, max_diff_length: Optional[int],
